    ...
    public class Ward
    {
        ...
        public static void DrawWardSpots()
        {
            foreach (Vector3 wardPos in WardSpots)
            {
                ...
                float[] screenPos = Drawing.WorldToScreen(wardPos);
        ...
        public static void DrawSafeWardSpots()
        {
            foreach (WardSpot safeWardSpot in SafeWardSpots)
            {
                ...
                float[] screenPos = Drawing.WorldToScreen(safeWardSpot.MagneticPosition);
                if (IsOnScreen(screenPos[0], screenPos[1]))
                {
                    ...
                    float[] screenMagneticPos = Drawing.WorldToScreen(safeWardSpot.MagneticPosition);
                    float[] screenDirectionVector = Drawing.WorldToScreen(newVector);
